  ...
  return (
    <div className="mb-8 animate-fade-up" style={{ animationDelay: '100ms' }}>
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Language Expertise</h2>
          <p className="text-sm text-gray-500">Your language proficiency and performance</p>
        </div>
      </div>
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-sm font-medium">{lang.proficiency}</span>
                    <span className="text-sm text-gray-500">· {lang.tasksCompleted} tasks</span>
                  </div>
                </div>
                <span className={cn(
                  "text-sm font-medium",
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">{lang.badge}</span>
                </div>
