  ...
  return <div className="flex items-center gap-3">
      <div className="relative w-12 h-12">
        ...
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#4F46E5] to-[#0EA5E9] flex items-center justify-center shadow-lg rotate-45">
          {/* Inner circle with same gradient direction as diamond for visual consistency */}
          <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#0EA5E9] to-[#4F46E5] flex items-center justify-center transform -rotate-45 border border-white/10">
