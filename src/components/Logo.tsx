export const Logo = () => {
  return <div className="flex items-center gap-3">
      <div className="relative w-12 h-12">
        ...
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-b dark:from-[#0EA5E9] dark:via-[#0284C7] dark:to-[#0369A1] from-[#60A5FA] via-[#3B82F6] to-[#2563EB] flex items-center justify-center shadow-lg rotate-45 text-[#0def0d]">
      ...
      <span className="font-bold text-2xl md:text-3xl drop-shadow text-slate-50">
        SpeakToEarn
      </span>
    </div>;
};