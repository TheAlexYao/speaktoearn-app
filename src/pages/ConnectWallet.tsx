      ...
      <div className="absolute inset-0">
        ...
        <div className="max-w-md mx-auto mt-16 space-y-8">
          ...
          <div className="text-center text-white space-y-4">
            ...
            <p className="text-lg text-white/90 animate-fade-up drop-shadow" style={{
          ...
          animationDelay: "300ms"
            ...
            <Button className="w-full text-lg py-6 bg-white hover:bg-white/90 text-[#4F46E5] font-semibold shadow-2xl hover:shadow-white/20 transition-all duration-300 border-0" variant="secondary" onClick={handleConnect}>
              Connect Wallet
            </Button>
          </div>

          {/* Footer */}
          <p className="text-center text-white/80 text-sm animate-fade-up drop-shadow" style={{
